...
########### ideally, would use this DF to automatically update DB!!

# print(facilities_df['latitude'])
# print(facilities_df['longitude'])

# # converts lat and long points to coordinate point data type
# geo = [Point(xy) for xy in zip(facilities_df.latitude, facilities_df.longitude)]
